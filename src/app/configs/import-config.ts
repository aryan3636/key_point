...
export const importTemplates: Record<ImportModuleKey, ImportTemplate> = {
  ...
  projects: {
    ...
    headers: ["projectName", "jobNumber", "customerName", "addressLine1", "addressLine2", "city", "state", "zipCode", "projectDate", "preparedBy", "status", "budget", "notes"],
    sampleRows: [
      ["Luxury Villa Fitout", "LVF-01", "Kapur Residence", "Villa 14", "Golf Course Road", "Gurugram", "Haryana", "122002", "2026-04-12", "Aarav Meena", "Draft", "4200000", "Kitchen and pantry scope"],
      ["Retail Joinery Rollout", "RJR-11", "Northline Retail", "Store 8", "Delhi NCR", "Delhi", "Delhi", "110001", "2026-04-18", "Neha Chauhan", "In Review", "2650000", "Areas to be added after survey"],
    ],
    instructions: [
      "Job number should stay unique per row.",
      "Budget should be entered as a number without commas.",
      "Areas / Rooms can be added after import from the project detail page.",
