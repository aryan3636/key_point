...
export const importTemplates: Record<ImportModuleKey, ImportTemplate> = {
  ...
  projects: {
    ...
    headers: ["projectName", "jobNumber", "customerName", "siteAddress", "projectDate", "preparedBy", "status", "location", "budget", "notes"],
    sampleRows: [
      ["Luxury Villa Fitout", "LVF-01", "Kapur Residence", "Gurugram", "2026-04-12", "Aarav Meena", "Active", "Gurugram", "4200000", "Kitchen and pantry scope"],
      ["Retail Joinery Rollout", "RJR-11", "Northline Retail", "Delhi NCR", "2026-04-18", "Neha Chauhan", "Planning", "Delhi NCR", "2650000", "Areas to be added after survey"],
    ],
    instructions: [
      "Job number should stay unique per row.",
      "Budget should be entered as a number without commas.",
      "Areas / Rooms can be added after import from the project edit flyout.",
